...
def show_results(request):
    ...
    try:
        ...
        tc_basecase_count = sum(1 for c in columns if c.endswith(' - Base Case') and 'Windspeed' in c)
        tc_worstcase_count = sum(1 for c in columns if c.endswith(' - Worst Case') and 'Windspeed' in c)
        tc_baseline_cols = [
            'Extreme Windspeed 10 year Return Period (km/h)',
            'Extreme Windspeed 20 year Return Period (km/h)',
            'Extreme Windspeed 50 year Return Period (km/h)',
